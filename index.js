...
// == "Employees"/ READ all, SELECT * FROM
...
// == "Employees by Department" / READ by, SELECT * FROM
...
//  choose the department list, employees pop up
...
function promptInsert(roleChoices) {
  ...
  inquirer
    ...
    .then(function (answer) {
      ...
      // finished prompting, insert a new item into the db with that info
